...
def plot_cloud_cluster(cluster, sph, title, vrange=[-6,2]):
    ...
    if len(sph.dm_particles) > 0:
        ...
        ax.scatter(stars_to_be_plotted.x.value_in(units.parsec), stars_to_be_plotted.y.value_in(units.parsec), s=2,\
...
#    lr_cluster.append(Lagrang_radii(cluster, converter))
    ...
    for i,t in enumerate(times):
        ...
        sph.evolve_model(t, timestep=dt_bridge)
